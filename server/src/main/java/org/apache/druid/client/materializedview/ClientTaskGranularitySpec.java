 ...
 */
public class ClientTaskGranularitySpec
{
  private final Granularity segmentGranularity;
  private final Granularity queryGranularity;
  private final Boolean rollup;
  @JsonCreator
  public ClientTaskGranularitySpec(
  ...
  )
  {
    ...
    Preconditions.checkNotNull(queryGranularity, "queryGranularity can not null");
    if (segmentGranularity == null) {
      this.segmentGranularity = Comparators.granularityGreaterFirst().compare(queryGranularity, Granularities.HOUR) < 0
                                ? queryGranularity
                                : Granularities.HOUR;
    } else {
  ...
  public ClientTaskGranularitySpec withSegmentGranularity(Granularity segmentGranularity)
  {
    return new ClientTaskGranularitySpec(segmentGranularity, queryGranularity, rollup);
  }
  ...
  public boolean equals(Object o)
  {
    ...
    ClientTaskGranularitySpec that = (ClientTaskGranularitySpec) o;
