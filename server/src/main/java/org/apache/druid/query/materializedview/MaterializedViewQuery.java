 ...
 */
public class MaterializedViewQuery<T> extends BaseQuery<T>
{
  ...
  public MaterializedViewQuery(
      @JsonProperty("query") BaseQuery query,
      @JacksonInject MaterializedViewOptimizer optimizer
  )
  {
  ...
  {
    return new MaterializedViewQuery((BaseQuery) query.withOverriddenContext(contextOverride), optimizer);
  }

  @Override
  public MaterializedViewQuery withQuerySegmentSpec(QuerySegmentSpec spec)
  {
    return new MaterializedViewQuery((BaseQuery) query.withQuerySegmentSpec(spec), optimizer);
  }
  ...
  {
    return new MaterializedViewQuery<>((BaseQuery) query.withSubQueryId(subQueryId), optimizer);
  }

  @Override
  public Query<T> withOverriddenGranularity(Granularity granularity)
  {
    return new MaterializedViewQuery<>((BaseQuery) query.withOverriddenGranularity(granularity), optimizer);
  }
  ...
  {
    return new MaterializedViewQuery((BaseQuery) query.withDataSource(dataSource), optimizer);
  }
  ...
  public static class Builder
  {
    ...
    private MaterializedViewOptimizer dataSourceOptimizer;

    public Builder query(BaseQuery query)
    {
      this.query = query;
      return this;
    }

    public Builder optimizer(MaterializedViewOptimizer mvOptimizer)
    {
      this.dataSourceOptimizer = mvOptimizer;
      return this;
    }

    public MaterializedViewQuery build()
    {
      return new MaterializedViewQuery(query, dataSourceOptimizer);
    }
  }
}
