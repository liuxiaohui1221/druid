...
@JsonSubTypes(value = {
    @Type(name = MaterializedIntervalSpec.TYPE, value = MaterializedIntervalSpec.class),
    @Type(name = SpecificMaterializedSegmentsSpec.TYPE, value = SpecificMaterializedSegmentsSpec.class)
})
public interface MaterializedViewInputSpec
{
  default List<WindowedSegmentId> getSegments()
  {
    return null;
  }
   ...
   */
  Set<Interval> findInterval(String dataSource);
